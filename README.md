...
- Resources: `nagios_host`, `nagios_hostgroup`, `nagios_contact`, `nagios_contactgroup`, `nagios_service`, `nagios_servicegroup`, `nagios_authserver`, `nagios_timeperiod`, `nagios_command`, `nagios_nna_source`, `nagios_user`
...
<!-- throwaway line to test require-linked-issue check -->
